...
------------ | ------------- | ------------- | -------------
**ConnectTypesSupported** | [**[]CommandConnectTypesSupported**](CommandConnectTypesSupported.md) | This object is used to enumerate the Command Shell connection types allowed by the implementation. | [optional] 
